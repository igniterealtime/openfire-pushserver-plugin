...
class PushServerProperty: PropertyEventListener {
    ...
    enum class Property(val key: String) {
        PROPERTY_NAME_FCM_PROJECT_ID("pushserver.google.fcm.projectId")
        , PROPERTY_NAME_APNS_TEAM_ID("pushserver.apple.apns.teamId")
        , PROPERTY_NAME_APNS_KEY("pushserver.apple.apns.key")
        , PROPERTY_NAME_APNS_BUNDLE_ID("pushserver.apple.apns.bundleId");
